...
from ememediaforge.scenes.base import BaseScene, ease_in_out
...
class OutroScene(BaseScene):
    ...
    def render(self, local_t: float) -> Image.Image:
        ...
        self.draw_text_centered(draw, self.title, cy - title_size // 2, f_title, title_color)
        ...
        if self.url:
            ...
            self.draw_text_centered(
                draw, self.url, cy + title_size + int(self.height * 0.03), f_url, url_color
            )
        ...
        self.draw_text_centered(
            draw,
            "Made with EmemediaForge by @Ememzyvisuals",
